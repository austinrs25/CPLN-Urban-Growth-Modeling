...
Aging stormwater infrastructure is a known problem in the Charlotte MSA. With the city's rapidly growing population, stormwater management is all the more important to absorb runoff and reduce the risk of combined sewer overflows during storm events. As Charlotte seeks to modernize its stormwater infrastructure, green infrastructure projects such as rain gardens should be incorporated to reduce strain on existing drainage systems. This type of infrastructure can also help offset the worsening of the urban heat island effect caused by tree canopy loss.
...
In our model, the majority of cells predicted to convert from undeveloped to developed between 2019 and 2027 are forested areas in Mecklenburg County. As such, upzoning in Mecklenburg County is recommended to help accommodate population growth while limiting the destruction of forested areas.
