...
**Several custom built functions are use in this workflow:** 
...
```
## 2.3. Load Land Cover for t1 and t2

Below we call our raster land cover data for our two time periods we are interested in - **2011 (t1)** and **2019 (t2)**. 
