...
# 17. Credits
This report is completed as an assignment for the University of Pennsylvania Spring 2025 course **CPLN 6750/MUSA 6750: Land Use and Environmental Modeling** in the Department of City and Regional Planning at the Stuart Weitzman School of Design taught by **Michael Fichman**. This was completed by **Abe Doroshow & Austin Studner (Sutherland)**. The workflow in this Urban Growth Model were created by Michael Fichman, the late Prof. Ken Steif, and Jenna Epstein for the course, and adapted and inspired from the California Urban Futures Model, developed by Prof. Emeritus John Landis. 
