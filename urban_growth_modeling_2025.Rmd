...
We obtained land cover data from the Multi-Resolution Land Characteristics (MRLC) consortium (https://www.mrlc.gov/data?f%5B0%5D=category%3ALand%20Cover), covering 2011 and 2019. Census and infrastructure datasets were sourced from federal and local open data repositories. All datasets were clipped to the study region and rasterized to a uniform resolution to enable pixel-level predictive modeling.
