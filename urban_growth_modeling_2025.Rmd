...
```{r}
dat_2027_preds2 <- dat_2019_updated %>%
...
ggplot(data=dat_2027_preds2) +
  geom_point(aes(x=xyC(dat_2027_preds2)[,1], 
                 y=xyC(dat_2027_preds2)[,2], colour = Prediction)) +
...
4. ALERT 4: In Step 7, **write narrative imapcts assessment** based on 2028 forecast results### Assessment of impact - where is development likely to occur? Are sensitive lands at risk? Where?
